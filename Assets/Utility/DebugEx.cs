...
namespace QuickshotBlitz
{
    public class DebugEx : MonoBehaviour
    {
        ...
        public static Vector2 position = new(10f, 10f);
        ...
        private static readonly object[] elements = new object[MaxLines];
        ...
        bool KeysPressed()
        {
            ...
            return keys[^1].wasPressedThisFrame;
        }
        void OnGUI()
        {
            if (!Activated)
        ...
        public static void DrawRect(Rect r, Color color)
        {
            ...
            Vector2 se = new(r.x + r.width, r.y);
            Vector2 nw = new(r.x, r.y + r.height);
        ...
        public static void DrawPoints(IEnumerable<Vector2> positions, Color color, float size = 1f)
        {
            foreach (var pos in positions)
            {
                DrawCross(pos, color, size);
            }
        }
