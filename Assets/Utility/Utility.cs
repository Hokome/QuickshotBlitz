...
#nullable disable
        ...
        //{
        //if (DiffB(a.a, b.a) > err) return false;
        //if (DiffB(a.r, b.r) > err) return false;
        //if (DiffB(a.g, b.g) > err) return false;
        //if (DiffB(a.b, b.b) > err) return false;
        //return true;
        //}
        //private static byte DiffB(byte a, byte b) => (byte)Math.Abs(a - b);
