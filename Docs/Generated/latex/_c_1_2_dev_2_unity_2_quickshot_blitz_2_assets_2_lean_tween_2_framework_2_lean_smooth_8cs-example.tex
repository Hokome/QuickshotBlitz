\doxysection{C\+:/\+Dev/\+Unity/\+Quickshot\+Blitz/\+Assets/\+Lean\+Tween/\+Framework/\+Lean\+Smooth.\+cs}
\hypertarget{_c_1_2_dev_2_unity_2_quickshot_blitz_2_assets_2_lean_tween_2_framework_2_lean_smooth_8cs-example}{}\label{_c_1_2_dev_2_unity_2_quickshot_blitz_2_assets_2_lean_tween_2_framework_2_lean_smooth_8cs-example}Moves one value towards another (eases in and out to destination with no overshoot)

Moves one value towards another (eases in and out to destination with no overshoot)@method Lean\+Smooth.\+damp (float) 
